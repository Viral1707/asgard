...
public class HomePg {
	...
	By Settings = By.xpath("//*[@id='mainWrapper']/mdb-navbar[1]/nav/div/div[2]/links/ul[2]/li[5]/a");
	By Logout = By.xpath("//*[@id='mainWrapper']/mdb-navbar[1]/nav/div/div[2]/links/ul[2]/li[4]/div/a[4]");
	By StgHp = By.xpath("//*[@id='mainWrapper']/mdb-navbar[1]/nav/div/div[2]/links/ul[2]/li[5]/a");

...
public class HomePg {
	...
	By UserSet = By.xpath("//*[@id='mainWrapper']/mdb-navbar[1]//links//li[3]/a/i");
	By Settings = By.xpath("//*[@id='mainWrapper']/mdb-navbar[1]/nav/div/div[2]/links/ul[2]/li[4]/a/i");
	By Logout = By.xpath("//*[@id='mainWrapper']/mdb-navbar[1]//li[3]/div/a[4]");
